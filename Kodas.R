...
# ggh1 <- ggs_histogram(gg11) + theme_bw() + xlab("Reikšmė") + ylab("Dažnis")
ggd1 <- ggs_density(gg11) + theme_bw() + xlab("Reikšmė") + ylab("Dažnis") +
  scale_fill_discrete("Grandinė") + scale_colour_discrete("Grandinė")
ggtr1 <- ggs_traceplot(gg11) + theme_bw() + xlab("Iteracija") + ylab("Reikšmė") +
  scale_fill_discrete("Grandinë") + scale_colour_discrete("Grandinė")
...
# ggs_Rhat(gg11) 
gggew1 <- ggs_geweke(gg11) + theme_bw() + xlab("z-reikšmė") + ylab("Parametras") +
  labs(title = "Geweke diagnostika") + scale_fill_discrete("Grandinė") + 
  scale_colour_discrete("Grandinė") 
...
#--------------------Asimetrinių Normaliųjų pajamų modelis----------------------------
...
# ggmcmc(gg20)
# ggh2 <- ggs_histogram(gg20) + theme_bw() + xlab("Reikšmė") + ylab("Dažnis")
ggd2 <- ggs_density(gg20) + theme_bw() + xlab("Reikšmė") + ylab("Dažnis") +
  scale_fill_discrete("Grandinė") + scale_colour_discrete("Grandinė")
ggtr2 <- ggs_traceplot(gg20) + theme_bw() + xlab("Iteracija") + ylab("Reikšmė") +
  scale_fill_discrete("Grandinė") + scale_colour_discrete("Grandinė")
...
ggcor2 <- ggs_crosscorrelation(gg20, absolute_scale = TRUE) + theme_bw() + 
  theme(legend.title = element_blank()) 
# ggs_Rhat(gg20) 
gggew2 <- ggs_geweke(gg20) + theme_bw() + xlab("z-reikšmė") + ylab("Parametras") +
  labs(title = "Geweke diagnostika") + scale_fill_discrete("Grandinė") + 
  scale_colour_discrete("Grandinė") 
...
#--------------------Asimetrinių Normaliųjų atsitiktinių efektų modelis------------------------
...
ggplot(densv, aes(x = sigv, fill = veikla)) + geom_density(alpha = .3) + theme_bw() +
  ylab("Tankis") + xlab("Reikšmė") + scale_x_continuous(limits = c(0, 10)) + 
...
plotdf <- data.frame(x = heiddf$indeksas, y = unlist(heiddf[, 1:3]), veikla = heiddf$veikla,
  Grandinė = factor(rep(1:3, each = nrow(heiddf))))
ggplot(data = plotdf, aes(x = x, y = y, color = Grandinė)) +
  geom_line() + xlab("Veikla") + ylab("p-reikšmė") + theme_bw() + 
...
# ggmcmc(gg31)
# ggh2 <- ggs_histogram(gg31) + theme_bw() + xlab("Reikšmė") + ylab("Dažnis")
ggd3 <- ggs_density(gg31) + theme_bw() + xlab("Reikšmė") + ylab("Dažnis") +
  scale_fill_discrete("Grandinė") + scale_colour_discrete("Grandinė")
ggtr3 <- ggs_traceplot(gg31) + theme_bw() + xlab("Iteracija") + ylab("Reikšmė") +
  scale_fill_discrete("Grandinė") + scale_colour_discrete("Grandinė")
...
ggcor3 <- ggs_crosscorrelation(gg31, absolute_scale = TRUE) + theme_bw() + 
  theme(legend.title = element_blank())
# ggs_Rhat(gg31) 
gggew3 <- ggs_geweke(gg31) + theme_bw() + xlab("z-reikšmė") + ylab("Parametras")  +
  labs(title = "Geweke diagnostika") + scale_fill_discrete("Grandinė") + 
  scale_colour_discrete("Grandinė") 
...
#---------------------------Visų modelių prognozių palyginimas------------------------------------------
...
ggplot(data = prodf, aes(x = prognoze, y = logy, color = Modelis)) + geom_point(size = 2.3) + 
  xlab("Tikrosios reikšmė s") + ylab("Prognozuotos reikšmė s") + theme_bw() + 
...
ggplot(data = paklvsprdf, aes(x = progn, y = skirt, color = Modelis)) + geom_point(size = 2.3) + 
  xlab("Prognozė") + ylab("Prognozė s paklaida") + theme_bw() + geom_hline(aes(intercept = 0), 
    color = "#666666", size = 1) 
...
ggplot(sddf, aes(x = index, y = sd, colour = Modelis)) + geom_line() + theme_bw() + 
  ylab("Prognozė s dispersija") + xlab("Indeksas")  
...
ggs_caterpillar(list("2 modelis" = ggs(mcmc2y), "3 modelis" = ggs(mcmc3y)), horizontal = F) + 
  theme_bw() + ylab("Prognozė") +
  theme(axis.text.x = element_blank(), axis.ticks = element_blank())

#-------------------------3 modelio su 1 palyginimas, kur asimetrija didžiausia-------------------
...
#------------------------------------------Generuotos pajamos pagal 3 modelį--------------------------------------------------
...
dfr <- data.frame(mz)
ggplot(dfr, aes(x = mz)) + geom_histogram(binwidth = 2.5) + theme_bw() + ylab("Dažnis") +
  xlab("Vidutinis darbuotojų  skaič ius veikloje")
...
ggplot(D1, aes(info, fill = kas)) + geom_bar() + theme_bw() + ylab("Dažnis") + 
  xlab("Firmų  skaič ius") + scale_fill_grey(start = 0.3, end = .6) + 
  theme(legend.title = element_blank()) + ggtitle("Didelė s firmos")
...
ggplot(D2, aes(info, fill = kas)) + geom_bar() + theme_bw() + ylab("Dažnis") + 
  xlab("Firmų skaičius") + scale_fill_grey(start = 0.3, end = .6) + 
  theme(legend.title = element_blank()) + ggtitle("Vilniaus didelė s firmos")

#------------------------Vilniaus ir Kauno didelės firmos------------------------------------
...
ggplot(D3, aes(info, fill = kas)) + geom_bar() + theme_bw() + ylab("Dažnis") + 
  xlab("Firmų  skaič ius") + scale_fill_grey(start = 0.3, end = .6) + 
  theme(legend.title = element_blank()) + ggtitle("Vilniaus ir Kauno didelė s firmos")

#-----------------------------Kauno didelės firmos--------------------------------------
...
ggplot(D4, aes(info, fill = kas)) + geom_bar() + theme_bw() + ylab("Dažnis") + 
  xlab("Firmų  skaič ius") + scale_fill_grey(start = 0.3, end = .6) + 
  theme(legend.title = element_blank()) + ggtitle("Kauno didelė s firmos")

#---------------------------- Klaipėdos, Panevėžio ir Šiaulių didelės firmos ----------------------------------------------
...
ggplot(D5, aes(info, fill = kas)) + geom_bar() + theme_bw() + ylab("Dažnis") + 
  xlab("Firmų  skaič ius") + scale_fill_grey(start = 0.3, end = .6) + 
  theme(legend.title = element_blank()) + ggtitle("Klaipė dos, Panevė žio, Šiaulių  didelė s firmos")
